...
> = {
  ...
  meta: {
    modelProps: 'user' | 'product' | 'productDetails' | 'order';
    ...
    ProductDetails: {
      ...
      operations: {
        ...
        count: {
          ...
          result:
            | runtime.Types.Utils.Optional<Prisma.ProductDetailsCountAggregateOutputType>
            | number;
        };
      };
    };
...
export type ProductDetailsScalarFieldEnum =
  (typeof ProductDetailsScalarFieldEnum)[keyof typeof ProductDetailsScalarFieldEnum];
